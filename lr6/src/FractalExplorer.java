...
public class FractalExplorer
{
    ...
    private class FractalWorker extends SwingWorker<Object, Object> //fractalworker на основе swingworker
    {                                                               //облегчает процесс создания фонового потока

        int yCoordinate; //строка для изменения пикселев

        int[] computedRGBValues; //массив цветов нашей строки
        ...
        protected Object doInBackground() { //почти тоже самое что и был drawFractal, но
            ...
            for (int i = 0; i < computedRGBValues.length; i++) {
                ...
                if (iteration == -1){
                    computedRGBValues[i] = 0; //но цвета сперва сохран
                }
